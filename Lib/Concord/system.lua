...
---@class System
---@param ... table @Filters applied to the system. {{ComponentClass}, {ComponentClass, "FilterName"}}
---@return System
local System = {}
System.mt    = {
   __index = System,
...
---@param e Entity @The Entity to check for
---@return boolean @Whether the System contains a specific Entity.
